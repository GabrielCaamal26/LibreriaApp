    ...
    <section class="content">
        <div class="box">
            <div class="box-header ">
                <button class="btn btn-primary" data-toggle="modal" data-target="#CrearUsuario">Crear nuevo</buttonc>
            </div>
            <br>
            <div class="box-body">
                <table class="table tabl-bordered table-hover table-striped dtUsers">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Documento</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-success"><i class="fas fa-pencil-alt" data-togle="modal" data-target="#EditarUsuario"></i></button>    
                                </a>
